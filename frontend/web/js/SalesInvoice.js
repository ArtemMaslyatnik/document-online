...
///view list contract 
$(document).ready(function () {
    $('#button-list-contract').on('click', function () {
        
    $('#modal-list').modal('show');
    $('#modal-list').find('.modal-body').load('../../catalog/contract/index');
...
// create contract 
$(document).ready(function () {
        $('#modal-list').on('click', '#button-create-contract', function(event) { 
        $('#modal-list').modal('show');
        $('#modal-list').find('.modal-body').load('../../catalog/contract/create');
    });     
});
